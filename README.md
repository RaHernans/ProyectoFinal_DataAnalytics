...
Las ventas muestran una evolución estable a lo largo del tiempo. No obstante, 
este comportamiento global tiende a ocultar patrones relevantes. Por ello, se
...
además de productos de oficina. En este contexto, un único pedido puede concentrar un elevado 
número de unidades y un alto valor económico.
...
evitando la confusión derivada de sub-regiones internas con denominaciones poco
